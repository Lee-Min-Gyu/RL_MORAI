...
class BeVLightEncoder(nn.Module):
...
class BeVLightCombinedExtractor(BaseFeaturesExtractor):
    """
    Dict observation extractor that encodes BeV image keys and concatenates
